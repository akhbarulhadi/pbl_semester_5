...
const DashboardPengajar = () => {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
        ...
        <DataIncome title="Total Pengikut" total="470" rate="2.59%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="18"
      ...
      <h2 className="text-2xl font-bold mb-4 text-gray-700">TABLE KELAS</h2>
        <table className="min-w-full bg-white border border-gray-300">
          ...
          <tbody>
            {TableKelas.map((kelas, index) => (
              <tr key={index} className="hover:bg-gray-100">
                <td className="py-2 px-4 border-b">
                  <Link to={`/pengajar/detail-kelas/${encodeURIComponent(kelas.namaKelas)}`} className="text-blue-500 hover:underline">
                    {kelas.namaKelas}
                  </Link>
                </td>
