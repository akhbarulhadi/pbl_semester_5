...
const Signup = () => {
  ...
  const [foto, setFoto] = useState(null); // Tambahkan state untuk file foto
  ...
  const handleSignup = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      return;
        ...
        formData.append('foto', foto); // Tambahkan file foto
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Terjadi kesalahan saat membuat akun');
      }
