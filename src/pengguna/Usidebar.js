        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3 flex justify-between items-center">
          ...
          <div className="relative ml-4">
            <button 
              ...
              className="p-2 text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-200"
            >
            ...
            {isProfileMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 shadow-lg rounded-lg profile-menu">
                <Link 
                  to="/pengguna/profile" 
      ...
      <aside className={`fixed left-0 z-40 w-64 mt-16 h-full bg-gradient-to-b from-blue-700 to-blue-500 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-y-auto transition-transform transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 mobile-menu`}>
        <div className="h-full px-3 py-4">
          <ul className="space-y-4 font-medium">
            ...
            <li>
              <Link 
                to="/pengguna/semua-kursus" 
                className={`flex items-center p-3 rounded-lg transition-all duration-300 ${location.pathname === '/dashboard/pengguna/semua-kursus' ? 'text-white bg-blue-800' : 'text-white hover:bg-blue-800 dark:hover:bg-gray-700'}`} 
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <span className="ml-3 flex-1 whitespace-nowrap">Semua Kursus</span>
              </Link>
            </li>
            <li>
              <Link 
            ...
            <li>
              <Link 
                ...
                className={`flex items-center p-3 rounded-lg transition-all duration-300 ${location.pathname === '/dashboard/pengguna/sertifikat' ? 'text-white bg-blue-800' : 'text-white hover:bg-blue-800 dark:hover:bg-gray-700'}`} 
                onClick={() => setIsMobileMenuOpen(false)}
              >
