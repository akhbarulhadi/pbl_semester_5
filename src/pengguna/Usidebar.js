          ...
          <ul className="space-y-4 font-medium text-gray-200">
            <li>
              <Link 
                ...
                className={`flex items-center p-4 rounded-lg transition-all duration-300 ${location.pathname === '/pengguna/dashboardU' ? 'bg-gray-600' : 'hover:bg-gray-600'}`} 
            ...
            <li>
              <Link 
                to="/pengguna/kursus" 
                className={`flex items-center p-4 rounded-lg transition-all duration-300 ${location.pathname === '/pengguna/kursus' ? 'bg-gray-600' : 'hover:bg-gray-600'}`} 
                onClick={() => setIsMobileMenuOpen(false)}
              >
            ...
            <li>
              <Link 
                ...
                className={`flex items-center p-4 rounded-lg transition-all duration-300 ${location.pathname === '/pengguna/transaksi' ? 'bg-gray-600' : 'hover:bg-gray-600'}`} 
                onClick={() => setIsMobileMenuOpen(false)}
              >
            ...
            <li>
              <Link 
                ...
                className={`flex items-center p-4 rounded-lg transition-all duration-300 ${location.pathname === '/pengguna/sertifikat' ? 'bg-gray-600' : 'hover:bg-gray-600'}`} 
                onClick={() => setIsMobileMenuOpen(false)}
              >
